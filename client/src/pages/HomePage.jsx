...
function SaveModal({ open, onClose, onConfirm, loading, selectedCount = 0 }) {
  ...
  return (
    <AnimatePresence>
      {open && (
        ...
        >
          <motion.div
            className="w-full max-w-[440px] overflow-hidden rounded-[22px] bg-white shadow-[0_24px_60px_rgba(0,0,0,0.18)]"
